...
void DindingSisiKanan(){
	...
	glVertex3f(-700.0, -70.0, 110.0);//kiri bawah
	glVertex3f(-700.0, -40.0, 110.0);//kiri atas
	glVertex3f(-700.0, -40.0, 90.0);//kanan atas
	glVertex3f(-700.0, -70.0, 90.0);//kanan bawah
	glEnd();
